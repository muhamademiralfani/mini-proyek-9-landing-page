...
const ClientPartnerComponent = () => {
  ...
  return (
    <div className="w-full bg-gray-50 py-20 flex flex-col justify-center items-center">
      <div className="max-w-screen-lg mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:px-0 md:px-8 px-0">
          {dataLogo.map((item, index) => (
            <div
              key={index}
              className={`flex justify-center items-center border-b border-r border-gray-600
            ...
            >
              <img
                src={item}
                alt=""
                className="grayscale opacity-20 hover:opacity-100 transition-opacity duration-300"
              />
            </div>
          ))}
        </div>
